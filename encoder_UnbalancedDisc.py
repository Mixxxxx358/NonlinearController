...
Q1 = np.zeros((ny,ny)); np.fill_diagonal(Q1, [10])
...
controller_1 = VelocityMpcController(system, model, Nc, Q1, Q2, R, P, qlim, wlim, nr_sim_steps=nr_sim_steps, \
                                     max_iter=max_iter, n_stages=1, numerical_method=1, model_simulation="LPV", factorization_method="CasADi")
...
controller_3 = VelocityMpcController(system, model, Nc, Q1, Q2, R, P, qlim, wlim, nr_sim_steps=nr_sim_steps, \
                                      max_iter=max_iter, n_stages=1, numerical_method=1, model_simulation="LPV", factorization_method="encoder")
